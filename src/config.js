...
// ===== 相機預設位置 =====
// 根據新的公寓佈局調整 (擴大主臥 + 縮小工作室)
export const CAMERA_VIEWS = {
  // 公領域 - 正常視角
  living: { pos: [-4, 2.5, -3], target: [0, 0.8, 0] },
  kitchen: { pos: [6, 2.5, -2], target: [4, 0.8, 0] },
  // 私領域 - 斜上方俯視 (較近距離，能看清家具)
  master: { pos: [-2.5, 4, 2.5], target: [0, 0.5, 4.5] },
  study: { pos: [1, 3.5, 2.5], target: [2.2, 0.5, 4.5] },
  bath: { pos: [3, 3.5, 2.5], target: [4.3, 0.5, 4.5] },
  // 全屋俯視
